"""
bsub -n 64 -o ~/lr25_code/output/%J.log -q psanaq  mpirun python ana_delay3.py

bsub -n 64 -o ~/lr25_code/output/%J.log -q psnehhiprioq  mpirun python ana_delay3.py --run 77
"""
