"""
bsub -n 64 -o ~/lr25_code/output/%J.log -q psanaq  mpirun python ana_delay5.py

bsub -n 64 -o ~/lr25_code/output/%J.log -q psnehhiprioq  mpirun python ana_delay5.py --run 177
...
if rank==0:
	filename = "/reg/neh/home5/sjarosch/lr25_code/npz/ana_delay5_run_%04d" %run
